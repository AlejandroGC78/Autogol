...
//include '../modelos/conexion.php';
include './carrito.php';
// Consulta SQL para obtener la cantidad de productos vendidos
$query = "SELECT p.nombre AS producto, COUNT(v.id_productos) AS cantidad
          FROM tblproductos p
          INNER JOIN tblventas_detalle v ON p.ID = v.id_productos
          GROUP BY p.nombre";
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
    $data[] = [$row['producto'], intval($row['cantidad'])];
}
?>
        ...
        <nav class="navbar  navbar-expand-lg navbar-light " style="background-color: #2b2a2c">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="../vistas/login.php">Mi perfil</a>
                </li>
                <li class="nav-item">
